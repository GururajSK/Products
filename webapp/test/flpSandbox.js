		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#gsklistmylist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gsklistmylist-display": {
								"semanticObject": "gsklistmylist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gsk.list.mylist",
									"url": sap.ui.require.toUrl("gsk/list/mylist")
								}
							}
						}
					}
